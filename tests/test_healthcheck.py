...
from vlab_snapshot_api.lib.views import healthcheck
...
class TestHealthView(unittest.TestCase):
    ...
    def test_health_check(self):
        """A simple test to verify the /api/1/inf/snapshot/healthcheck end point works"""
        resp = self.app.get('/api/1/inf/snapshot/healthcheck')
